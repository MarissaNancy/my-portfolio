    ...
    return (
        <main>
            ...
            <section className="relative min-h-screen pt-12 lg:pt-64 px-8">
                <h1 className="text-5xl text-white leading-none lg:leading-snug flex justify-center font-bold ">I'm Nancy!</h1>
                <div>
                <p className="text-3xl text-white flex justify-center m-5">
